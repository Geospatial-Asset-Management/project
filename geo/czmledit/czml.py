...
class Billboard(_CZMLBaseObject):
    ...
    _properties = ('show','image','color','scale','heightReference','clampToGround',)
...
class CZMLPacket(_CZMLBaseObject):
    ...
    _properties = ('id', 'name', 'description', 'status', 'version', 'availability', 'billboard', 'clock', 'position', 'label', 'point', 'positions', 'polyline', 'polygon', 'path', 'orientation', 'ellipse', 'ellipsoid', 'cone', 'pyramid',)
